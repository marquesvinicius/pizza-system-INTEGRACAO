...
class ClientService {
  ...
  async listarTodos() {
    try {
      console.log("Consultando todos os clientes no banco de dados...");
      const result = await db.query("SELECT * FROM clients");
      console.log("Clientes retornados:", result.rows); // Verifique o que é retornado
      return result.rows;
    } catch (error) {
      console.error("Erro ao listar clientes:", error); // Log do erro
